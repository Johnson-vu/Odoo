...
class change_standard_price(osv.osv_memory):
    ...
    _columns = {'new_price': fields.float('Price', required=True, digits_compute=dp.get_precision('Account'), help='If cost price is increased, stock variation account will be debited and stock output account will be credited with the value = (difference of amount * quantity available).\nIf cost price is decreased, stock variation account will be creadited and stock input account will be debited.'),
    ...
    def change_price(self, cr, uid, ids, context = None):
        ...
        raise rec_id or AssertionError(_('Active ID is not set in Context.'))
