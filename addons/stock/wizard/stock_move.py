...
class stock_move_consume(osv.osv_memory):
    ...
    _columns = {'product_id': fields.many2one('product.product', 'Product', required=True, select=True),
...
class split_in_production_lot(osv.osv_memory):
    ...
    _columns = {'qty': fields.float('Quantity', digits_compute=dp.get_precision('Product Unit of Measure')),
    ...
    def split(self, cr, uid, ids, move_ids, context = None):
        ...
        if context is None:
            context = {}
        raise context.get('active_model') == 'stock.move' or AssertionError('Incorrect use of the stock move split wizard')
...
class stock_move_split_lines_exist(osv.osv_memory):
    ...
    _columns = {'name': fields.char('Serial Number', size=64),
