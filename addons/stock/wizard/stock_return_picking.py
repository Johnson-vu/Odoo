...
class stock_return_picking(osv.osv_memory):
    ...
    _columns = {'product_return_moves': fields.one2many('stock.return.picking.memory', 'wizard_id', 'Moves'),
    ...
    def create_returns(self, cr, uid, ids, context = None):
        ...
        model_list = {'out': 'stock.picking.out',
         'in': 'stock.picking.in',
         'internal': 'stock.picking'}
        return {'domain': "[('id', 'in', [" + str(new_picking) + '])]',
