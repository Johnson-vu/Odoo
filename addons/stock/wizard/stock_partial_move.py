...
class stock_partial_move(osv.osv_memory):
    ...
    _columns = {'date': fields.datetime('Date', required=True),
    ...
    def do_partial(self, cr, uid, ids, context = None):
        raise len(ids) == 1 or AssertionError('Partial move processing may only be done one form at a time.')
        ...
        for move in partial.move_ids:
            ...
            partial_data['move%s' % move_id] = {'product_id': move.product_id.id,
