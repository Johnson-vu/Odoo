...
class res_currency_account(osv.osv):
    ...
    def _get_conversion_rate(self, cr, uid, from_currency, to_currency, context = None):
        ...
        if account and account.currency_mode == 'average' and account.currency_id:
            ...
            cr.execute('select sum(debit-credit),sum(amount_currency) from account_move_line l where l.currency_id=%s and l.account_id=%s and ' + query, (account.currency_id.id, account.id))
