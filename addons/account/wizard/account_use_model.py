...
class account_use_model(osv.osv_memory):
    ...
    _columns = {'model': fields.many2many('account.model', 'account_use_model_relation', 'account_id', 'model_id', 'Account Model')}
    ...
    def create_entries(self, cr, uid, ids, context = None):
        ...
        return {'domain': "[('id','in', [" + ','.join(map(str, context['move_ids'])) + '])]',
         'name': 'Entries',
         'view_type': 'form',
         'view_mode': 'tree,form',
