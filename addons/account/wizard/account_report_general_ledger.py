...
class account_report_general_ledger(osv.osv_memory):
    ...
    _columns = {'landscape': fields.boolean('Landscape Mode'),
     'initial_balance': fields.boolean('Include Initial Balances', help="If you selected to filter by date or period, this field allow you to add a row to display the amount of debit/credit/balance that precedes the filter you've set."),
    ...
    def _print_report(self, cr, uid, ids, data, context = None):
        ...
        data['form'].update(self.read(cr, uid, ids, ['landscape',
         'initial_balance',
         'amount_currency',
         'sortby'])[0])
