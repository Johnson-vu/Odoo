...
class accounting_report(osv.osv_memory):
    ...
    _columns = {'enable_filter': fields.boolean('Enable Comparison'),
    ...
    _defaults = {'filter_cmp': 'filter_no',
     'target_move': 'posted',
    ...
    def check_report(self, cr, uid, ids, context = None):
        ...
        data = {}
        data['form'] = self.read(cr, uid, ids, ['account_report_id',
         'date_from_cmp',
         'date_to_cmp',
         'fiscalyear_id_cmp',
         'journal_ids',
        ...
        for field in ['fiscalyear_id_cmp',
         'chart_account_id',
         'period_from_cmp',
         'period_to_cmp',
         'account_report_id']:
    ...
    def _print_report(self, cr, uid, ids, data, context = None):
        data['form'].update(self.read(cr, uid, ids, ['date_from_cmp',
         'debit_credit',
         'date_to_cmp',
         'fiscalyear_id_cmp',
         'period_from_cmp',
