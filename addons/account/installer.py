...
class account_installer(osv.osv_memory):
    ...
    _columns = {'charts': fields.selection(_get_charts, 'Accounting Package', required=True, help='Installs localized accounting charts to match as closely as possible the accounting needs of your company based on your country.'),
    ...
    _defaults = {'date_start': lambda *a: time.strftime('%Y-01-01'),
    ...
    def modules_to_install(self, cr, uid, ids, context = None):
        modules = super(account_installer, self).modules_to_install(cr, uid, ids, context=context)
        chart = self.read(cr, uid, ids, ['charts'], context=context)[0]['charts']
