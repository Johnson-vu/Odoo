...
class bank(osv.osv):
    ...
    _columns = {'journal_id': fields.many2one('account.journal', 'Account Journal', help='This journal will be created automatically for this bank account when you save the record'),
     'currency_id': fields.related('journal_id', 'currency', type='many2one', relation='res.currency', readonly=True, string='Currency', help='Currency of the related account journal.')}
